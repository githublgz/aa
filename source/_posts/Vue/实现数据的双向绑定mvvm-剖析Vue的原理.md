...
![img](https://github.com/honeydlp/mvvm/raw/master/defineProperty/img/3.png)
...
- 指令的声明规定是通过特定前缀的节点属性来标记，如`中`v-text`便是指令
