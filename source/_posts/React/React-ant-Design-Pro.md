...
![img](https://gw.alipayobjects.com/zos/rmsportal/oXmyfmffJVvdbmDoGvuF.png)

**UserLayout：抽离出用于登陆注册页面的通用布局**

![img](https://gw.alipayobjects.com/zos/rmsportal/mXsydBXvLqBVEZLMssEy.png)
...
![img](https://gw.alipayobjects.com/zos/rmsportal/hjDyFTVOgRwDzAIHApMO.png)
...
> 加入菜单和路由的方式请参照 路由和菜单 - 添加路由/菜单 中的介绍完成。加好后，访问 `http://localhost:8000/#/new` 就可以看到新增的页面了 [https://pro.ant.design/docs/router-and-nav-cn#%E6%B7%BB%E5%8A%A0%E8%B7%AF%E7%94%B1/%E8%8F%9C%E5%8D%95](https://pro.ant.design/docs/router-and-nav-cn#添加路由/菜单)

![img](https://gw.alipayobjects.com/zos/rmsportal/xZIqExWKhdnzDBjajnZg.png)
...
![img](https://gw.alipayobjects.com/zos/rmsportal/jJQYzRyqVFBBamUOppXH.png)

> 来到刚才选中的项目页，点击『生成代码』的链接，会在下方生成不同引入方式的代码，下面会分别介绍

![img](https://gw.alipayobjects.com/zos/rmsportal/DbDSgiRukSANKWyhULir.png)
...
> 了解更多用法 [https://pro.ant.design/docs/biz-icon-cn#%E4%BA%8C%E3%80%81%E5%BC%95%E5%85%A5](https://pro.ant.design/docs/biz-icon-cn#二、引入)
...
了解更多 [https://pro.ant.design/docs/mock-api-cn#%E4%BD%BF%E7%94%A8-umi-%E7%9A%84-mock-%E5%8A%9F%E8%83%BD](https://pro.ant.design/docs/mock-api-cn#使用-umi-的-mock-功能)
