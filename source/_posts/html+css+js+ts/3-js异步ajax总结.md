...
![img](https://poetries1.gitee.io/img-repo/20191001/11.png)
...
![img](https://poetries1.gitee.io/img-repo/20191001/12.png)

- 再来看第二张图，传统的 `Web` 应用模式，用户的体验是割裂的，点击->等待->
  看到新的页面->再点击->再等待。而采用了`AJAX`技术之后，大部分的计算工作，都是在用户不察觉的情况下，交由服务器去完成了

![img](https://poetries1.gitee.io/img-repo/20191001/13.png)

![img](https://poetries1.gitee.io/img-repo/20191001/14.png)
...
![img](https://poetries1.gitee.io/img-repo/20191001/15.png)
...
![img](https://poetries1.gitee.io/img-repo/20191001/16.png)
